...
import com.xuncorp.guqin.media.audio.wav.WavOptions;
import com.xuncorp.guqin.media.audio.wav.WavSaveOptions;
import com.xuncorp.guqin.media.audio.wav.WavSaveOrder;
import com.xuncorp.guqin.media.tag.id3.ID3v22Frames;
import com.xuncorp.guqin.media.tag.id3.ID3v23Frames;
import com.xuncorp.guqin.media.tag.id3.ID3v24Frames;
import com.xuncorp.guqin.media.tag.id3.framebody.AbstractID3v2FrameBody;
import com.xuncorp.guqin.media.tag.id3.framebody.FrameBodyCOMM;
import com.xuncorp.guqin.media.tag.id3.framebody.FrameBodyTIPL;
import com.xuncorp.guqin.media.tag.id3.framebody.ID3v24FrameBody;
import com.xuncorp.guqin.media.tag.id3.valuepair.TextEncoding;
import com.xuncorp.guqin.media.tag.lyrics3.Lyrics3v2Fields;
import com.xuncorp.guqin.media.tag.options.PadNumberOption;
import com.xuncorp.guqin.media.tag.reference.GenreTypes;
import com.xuncorp.guqin.media.tag.reference.ID3V2Version;
import com.xuncorp.guqin.media.tag.reference.Languages;
import com.xuncorp.guqin.media.tag.vorbiscomment.VorbisAlbumArtistReadOptions;
import com.xuncorp.guqin.media.tag.vorbiscomment.VorbisAlbumArtistSaveOptions;
...
public class TagOptionSingleton {
     ...
     *
     * If {@code true}, map
     * {@link FieldKey#WORK} to {@link com.xuncorp.guqin.media.tag.id3.framebody.FrameBodyTIT1}
     * and {@link FieldKey#GROUPING} to {@link com.xuncorp.guqin.media.tag.id3.framebody.FrameBodyGRP1}.
     *
     * If {@code false}, map
     * {@link FieldKey#WORK} to special {@link com.xuncorp.guqin.media.tag.id3.framebody.FrameBodyTXXX}
     * and {@link FieldKey#GROUPING} to {@link com.xuncorp.guqin.media.tag.id3.framebody.FrameBodyTIT1}.
     *
     ...
     * <p>If {@code true}, map
     * {@link FieldKey#WORK} to {@link com.xuncorp.guqin.media.tag.id3.framebody.FrameBodyTIT1}
     * and {@link FieldKey#GROUPING} to {@link com.xuncorp.guqin.media.tag.id3.framebody.FrameBodyGRP1}.</p>
     *
     * <p>If {@code false}, map
     * {@link FieldKey#WORK} to special {@link com.xuncorp.guqin.media.tag.id3.framebody.FrameBodyTXXX}
     * and {@link FieldKey#GROUPING} to {@link com.xuncorp.guqin.media.tag.id3.framebody.FrameBodyTIT1}.</p>
     *
