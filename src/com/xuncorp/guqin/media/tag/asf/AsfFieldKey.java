...
import com.xuncorp.guqin.media.audio.asf.data.ContainerType;
import com.xuncorp.guqin.media.audio.asf.data.ContentBranding;
import com.xuncorp.guqin.media.audio.asf.data.ContentDescription;
...
public enum AsfFieldKey {
    ...
    MUSICBRAINZ_RECORDING_WORK("MUSICBRAINZ_RECORDING_WORK", true),
    MUSICBRAINZ_RECORDING_WORK_ID("MUSICBRAINZ_RECORDING_WORK_ID", true),
    MUSICBRAINZ_WORK_PART_LEVEL1("MUSICBRAINZ_WORK_PART_LEVEL1", true),
    MUSICBRAINZ_WORK_PART_LEVEL1_ID("MUSICBRAINZ_WORK_PART_LEVEL1_ID", true),
    ...
    MUSICBRAINZ_WORK_PART_LEVEL2_ID("MUSICBRAINZ_WORK_PART_LEVEL2_ID", true),
    ...
    MUSICBRAINZ_WORK_PART_LEVEL3_ID("MUSICBRAINZ_WORK_PART_LEVEL3_ID", true),
    ...
    MUSICBRAINZ_WORK_PART_LEVEL4_ID("MUSICBRAINZ_WORK_PART_LEVEL4_ID", true),
    ...
    MUSICBRAINZ_WORK_PART_LEVEL5_ID("MUSICBRAINZ_WORK_PART_LEVEL5_ID", true),
    MUSICBRAINZ_WORK_PART_LEVEL5_TYPE("MUSICBRAINZ_WORK_PART_LEVEL5_TYPE", true),
    MUSICBRAINZ_WORK_PART_LEVEL6_ID("MUSICBRAINZ_WORK_PART_LEVEL6_ID", true),
    ...
    PRODUCER_SORT("PRODUCER_SORT", false),
