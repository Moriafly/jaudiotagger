...
import com.xuncorp.guqin.media.tag.id3.valuepair.EventTimingTypes;

/**
 * A single synchronized tempo code. Part of a list of temnpo codes ({@link com.xuncorp.guqin.media.tag.datatype.SynchronisedTempoCodeList}), that are contained in
 * {@link com.xuncorp.guqin.media.tag.id3.framebody.FrameBodySYTC}
 *
