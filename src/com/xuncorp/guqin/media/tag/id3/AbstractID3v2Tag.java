...
import com.xuncorp.guqin.media.audio.exceptions.UnableToCreateFileException;
import com.xuncorp.guqin.media.audio.exceptions.UnableToModifyFileException;
import com.xuncorp.guqin.media.audio.generic.Utils;
import com.xuncorp.guqin.media.audio.mp3.MP3File;
import com.xuncorp.guqin.media.logging.ErrorMessage;
import com.xuncorp.guqin.media.logging.FileSystemMessage;
import com.xuncorp.guqin.media.tag.*;
import com.xuncorp.guqin.media.tag.datatype.DataTypes;
import com.xuncorp.guqin.media.tag.datatype.Pair;
import com.xuncorp.guqin.media.tag.id3.framebody.*;
import com.xuncorp.guqin.media.tag.id3.valuepair.ID3NumberTotalFields;
...
import com.xuncorp.guqin.media.utils.ShiftData;
...
public abstract class AbstractID3v2Tag extends AbstractID3Tag implements Tag {
    ...
    */
     ...
     */
    public static long getV2TagSizeIfExists(FileDescriptor fileDescriptor) throws IOException {
     ...
     *
     * @see com.xuncorp.guqin.media.tag.Tag#hasField(String)
     */
     ...
     * Is this tag empty
     *
     * @see com.xuncorp.guqin.media.tag.Tag#isEmpty()
     */
