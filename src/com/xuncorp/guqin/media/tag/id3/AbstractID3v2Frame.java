...
public abstract class AbstractID3v2Frame extends AbstractTagFrame implements TagTextField {
    ...
    public AbstractID3v2Frame(String identifier) {
        ...
        try {
            ...
            Class<AbstractID3v2FrameBody> c = (Class<AbstractID3v2FrameBody>) Class.forName("com.xuncorp.guqin.media.tag.id3.framebody.FrameBody" + identifier);
    ...
    protected AbstractID3v2FrameBody readBody(String identifier, ByteBuffer byteBuffer, int frameSize)
        ...
        try {
            switch (identifier) {
                ...
                default:
                    @SuppressWarnings("unchecked") Class<AbstractID3v2FrameBody> c = (Class<AbstractID3v2FrameBody>) Class.forName("com.xuncorp.guqin.media.tag.id3.framebody.FrameBody" + identifier);
