...
import com.xuncorp.guqin.media.tag.datatype.AbstractStringStringValuePair;
...
public abstract class ID3Frames extends AbstractStringStringValuePair {
     ...
     * {@link com.xuncorp.guqin.media.tag.FieldKey#GROUPING} is mapped to the
     * non-standard frame {@code GPP1} and {@link com.xuncorp.guqin.media.tag.FieldKey#WORK}
     * to {@code TIT1} instead of the regular mapping
     * ({@code GROUPING -> TIT1, WORK -> TXXX:WORK}).</p>
     *
     * <p>This method is called internally by {@link com.xuncorp.guqin.media.tag.TagOptionSingleton#setId3v2ITunes12_6WorkGroupingMode(boolean)}
