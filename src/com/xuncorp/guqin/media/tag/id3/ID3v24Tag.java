...
import com.xuncorp.guqin.media.tag.lyrics3.AbstractLyrics3;
import com.xuncorp.guqin.media.tag.lyrics3.Lyrics3v2;
import com.xuncorp.guqin.media.tag.lyrics3.Lyrics3v2Field;
...
public class ID3v24Tag extends AbstractID3v2Tag {
     ...
     * @param byteBuffer
     * @param size
     * @throws com.xuncorp.guqin.media.tag.InvalidTagException
     */
    private void readExtendedHeader(ByteBuffer byteBuffer, int size) throws InvalidTagException {
        ...
        if (extendedHeaderSize <= TAG_EXT_HEADER_LENGTH) {
            throw new InvalidTagException(ErrorMessage.ID3_EXTENDED_HEADER_SIZE_TOO_SMALL.getMsg("", extendedHeaderSize));
        }
    ...
    public void read(ByteBuffer byteBuffer) throws TagException {
        ...
        logger.config("Reading tag from file size set in header is:" + size);
