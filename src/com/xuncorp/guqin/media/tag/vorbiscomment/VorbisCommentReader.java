...
import com.xuncorp.guqin.media.audio.exceptions.CannotReadException;
...
public class VorbisCommentReader {
    ...
    // Logger Object
    public static Logger logger = Logger.getLogger("com.xuncorp.guqin.media.tag.vorbiscomment.VorbisCommentReader");
